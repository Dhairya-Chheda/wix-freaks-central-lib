export const STRIPE_LIVE_MODE = false;
export const STRIPE_LIVE_KEY = "STRIPE_KEY_LIVE";
export const STRIPE_TEST_KEY = "STRIPE_KEY_TEST";
export const STRIPE_SUCCESS_URL = "";
export const SRIPE_CANCEL_URL = "";
export const STRIPE_REFRESH_URL_CONNECT = "";
export const SRIPE_RETURN_URL_CONNECT = "";
export const SRIPE_RETURN_URL_CUST_PORTAL = "";
export const STRIPE_ENDPOINT_SECRET = "STRIPE_SECRET_ENDPOINT";
